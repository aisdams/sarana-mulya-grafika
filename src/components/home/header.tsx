  ...
  return (
    <div className='grid grid-cols-2 items-center justify-between mx-auto gap-5 mb-52'>
        <div className="pl-20 pt-32 relative">
            ...
            <div className="absolute right-0 -bottom-24 mx-auto justify-center text-center grid cursor-pointer">
                <Image src={ImageScrol} alt='' className='w-10 h-10 grid mx-auto animate-bounce' />
                <h1 className='mt-2 font-extralight text-graysmg text-sm tracking-widest    '>Scroll Down</h1>
            </div>
        </div>
